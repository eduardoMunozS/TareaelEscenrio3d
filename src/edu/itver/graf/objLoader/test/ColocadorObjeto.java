 ...
 * @author alumno
 */
public class ColocadorObjeto extends GLCanvas implements GLEventListener, KeyListener {
    ...
    int objSel = 0;
    private Object3d obj3,obj4,obj2,obj5,obj6,obj7;
    
    
    public ColocadorObjeto(String fileName) {
    ...
    public void init(GLAutoDrawable glad) {
        ...
        try {
            obj1 = or.Load("./data/casacampo.obj");
        ...
        try {
            obj2 = or.Load("./data/trees9.obj");
            System.out.println("Objeto 2 cargado :" + this.fileName);
            //gl.glTranslated(-10.3, -.5, 10);
          //  gl.glTranslatef(-1, -3, 0);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
           // gl.glTranslatef(-22, -22, 0);
            //gl.glTranslated(-1.9, -6.8, 0.0);
        } 
        
        
        try {
            obj3 = or.Load("./data/low_poly_tree/Lowpoly_tree_sample.obj");
        ...
        try {
            obj5 = or.Load("./data/low_poly_tree/Lowpoly_tree_sample.obj");
        ...
        try {
            obj6 = or.Load("./data/low_poly_tree/Lowpoly_tree_sample.obj");
      ...
      /*  
        try {
            obj7 = or.Load("./data/catgato/12161_Cat_v1_L2.obj");
    ...
    public void display(GLAutoDrawable glad) {
        ...
        */
        ...
        if (obj1 != null) {
            gl.glTranslatef(0, -32, 0);
           // gl.glScalef(2, 2, 2);
            //gl.glScaled(2, 2, 2);
          //  gl.glScalef(2, 2, 2);
            obj1.draw(gl);
            //gl.glColor3d(4657, 878, 12332);
            //gl.glTranslatef(0, 60, 0);
            
            
        }
                    //f2(enfrente atras) f1(arriba abajo) f(izquieda derecha)
        if (obj2 != null) {
